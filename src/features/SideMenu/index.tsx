...
const SideMenu = (): JSX.Element => {
  ...
  return (
    <div className="w-48 border-r-2 flex flex-col h-screen fixed bg-white">
      ...
      <div
        onClick={() => logout(logoutCallback)}
        className="flex px-3.5 py-3 border-t-2 bg-gray-200 active:bg-gray-400 cursor-pointer"
      >
