...
const AdminForm = ({ onSubmit }: IAdminForm): JSX.Element => {
  ...
  return (
    ...
    >
      <Input
        {...register(constant.INPUT_ADMIN_FIRST_NAME, {
          required: false,
          pattern: /.*/,
        })}
      ...
      />
      <Input
        {...register(constant.INPUT_ADMIN_LAST_NAME, {
          required: false,
          pattern: /.*/,
        })}
      ...
      />
      <Input
        {...register(constant.INPUT_ADMIN_EMAIL, {
          required: false,
          pattern: /.*/,
        })}
      ...
      />
      <Input
        {...register(constant.INPUT_ADMIN_PASSWORD, {
          required: false,
          pattern: /.*/,
        })}
